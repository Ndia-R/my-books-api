...
class BookChapterPageContentRepositoryTest {
    ...
    void setUp() {
        ...
        entityManager.getEntityManager().createNativeQuery("TRUNCATE TABLE book_chapter_page_contents;").executeUpdate();
    ...
    void testSoftDeleteAllByBookId_Success() {
        ...
        List<BookChapterPageContent> allPages = entityManager.getEntityManager()
                .createQuery("SELECT p FROM BookChapterPageContent p WHERE p.bookId = :bookId",
