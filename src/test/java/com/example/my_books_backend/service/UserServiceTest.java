...
import com.example.my_books_backend.service.impl.UserServiceImpl;
...
class UserServiceTest {
    ...
    void updateUserSubscriptionPlan_UserNotFound_ThrowsNotFoundException() {
        ...
        // When / Then
        assertThatThrownBy(() -> userService.updateUserSubscriptionPlan(targetUserId, new UpdateSubscriptionPlanRequest("FREE")))
            .isInstanceOf(NotFoundException.class);
